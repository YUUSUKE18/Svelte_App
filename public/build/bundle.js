...
var app = (function () {
    ...
    /* src/Other.svelte generated by Svelte v3.25.1 */

    const file = "src/Other.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "This is An Other Component";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 12, 0, 165);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const app = new App({
      target: document.body, // index.html
    });
